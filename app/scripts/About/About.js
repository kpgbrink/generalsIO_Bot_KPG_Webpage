    ...
    render() {
        ...
        return (
            <div className="about-page">
                <h1>Media Catalog</h1>
<br></br>
    <h3>Media Catalog is a web application that caters towards users that want a centralized place to store records of their music, books or movies. No only that, but it is also a hub to post comments about media and have discussions with others. We have utlized google logins so that users can distinguish who posted what and have private catalogs.</h3>
<br></br>
